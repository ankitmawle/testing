	...
	class API extends REST {
		...
		*/
	    ...
	    private function get_game_list() {
		 ...
		 private function get_game_listt() {
			$this->functions->getGameListt();
		}
		...
		private function get_myoff_transactions() {
			$this->functions->getMyoffTransactions();
		}
