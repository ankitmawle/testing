<?php
    ...
    $use_of_bonus = '20';       // use of bonus to join match and lottery in percentage
    ...
    class functions extends REST {
        ...
        public function getGameListt() {
            ...
            global $access_key;
                ...
                $query = "SELECT id, title, banner, url, type FROM game_detailss ORDER BY id ASC";
                $result = mysqli_query($connect,$query);
        ...
        public function getMyTransactions() {
         ...
         public function getMyoffTransactions() {
            include "../include/config.php";
            global $access_key;
                ...
                $query = "SELECT id, user_id, transaction_id, amount, wallet, note, coins, from_unixtime(created_at, '%d-%m-%Y') AS created_at, status  FROM tbl_offline_plyments WHERE user_id='$user_id' ORDER BY id DESC";
                $result = mysqli_query($connect,$query);
        ...
        public function joinMatch() {
            ...
            if(isset($_GET['match_id']) && isset($_GET['pubg_id'])) {
                            ...
                            $bonus = round(($use_of_bonus * $entryFee) / 100);
        ...
        public function AddMransaction() {
            include "../include/config.php";
            include "../public/transaction.php";
            global $access_key;
                ...
                if(isset($_GET['transaction_id'])) {
                    ...
                    $sql = "Select id from tbl_offline_plyments WHERE user_id = '$user_id' AND status = '0'";
                    $res = mysqli_query($connect, $sql);
                    $num_res = mysqli_num_rows($res);
                    
                    if ($num_res == 0) {    
                        $qry = "SELECT cur_balance, won_balance FROM tbl_offline_plyments WHERE id = '$user_id'"; 
                        $userdata = mysqli_fetch_array(mysqli_query($connect,$qry)); 
                        ...
                        $set['result'][] = array('msg' => "Oops! You can't send new add play coins request until old one review.",'success'=>'0');
                        header( 'Content-Type: application/json; charset=utf-8' );
                        echo $json = json_encode($set);
                        mysqli_close($connect);
                    }
