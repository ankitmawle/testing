...
if(isset($_GET['withdrawId']))
{
  ...
  $insquery = "update tbl_offline_plyments set status=2 where id={$withdrawId}";
...
if(isset($_POST['btnReject']))
{
  ...
  $insquery = "update tbl_offline_plyments set status=1 where id=$txtRid";
    if(mysqli_query($conn,$insquery))
    {
      $seluDet = "select * from tbl_offline_plyments where id=$txtRid";
      $selres4 = mysqli_query($conn,$seluDet);
      if($selres48 = mysqli_fetch_array($selres4))
      {
        $upUsrBal = "update user_details set cur_balance=cur_balance+".$selres48['coins']." where id=".$selres48['user_id'];
                    ...
                    <div class="card-box">
                        ...
                        <div class="post-wrapper">
                          ...
                          // Count of all records 
                            $query   = $conn->query("SELECT COUNT(*) as rowNum FROM tbl_offline_plyments where coins>0");
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <label>Accepet Reason</label>
            <textarea class="form-control" name="txtRejReason" placeholder="e.g Accepted" required></textarea>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-default" name="btnReject">Accept</button>
            </form>
          </div>
        </div>
