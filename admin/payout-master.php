                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <select name="txtPayMethod" parsley-trigger="change" required class="form-control" id="txtPayMethod">
                                    ...
                                    <option <?php if($getres1['title'] == 'RazorPay') { echo 'selected'; } ?> value="RazorPay">RazorPay</option>
                                    <option <?php if($getres1['title'] == 'Paykun') { echo 'selected'; } ?> value="Paykun">Paykun</option>
                                    ...
                                    <option <?php if($getres1['title'] == 'MultiUpi') { echo 'selected'; } ?> value="MultiUpi">MultiUpi</option>
                                    <option <?php if($getres1['title'] == 'Bkash') { echo 'selected'; } ?> value="Bkash">Bkash</option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <select name="txtPayMethod" parsley-trigger="change" required class="form-control" id="txtPayMethod">
                                    ...
                                    <option value="MultiUpi">MultiUpi</option>
