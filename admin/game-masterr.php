...
$selquery = "select * from game_detailss order by id desc";
...
if(isset($_POST['btnSave']))
{
  ...
  $selquery ="select * from game_detailss where title='$txtTitle'";
  ...
  {
      $insquery = "insert into game_detailss (title,banner,url,type) values('{$txtTitle}','{$txtImg}','{$txtUrl}','{$txtType}')";
  }
  if(mysqli_query($conn,$insquery))
    {
      header("Location:game-masterr");
    }
    else
    {
        //echo $insquery;
...
if(isset($_GET['id']))
{
  ...
  $getquery1 = "select * from game_detailss where id={$id}";
...
if(isset($_POST['btnUpdate']))
{
  ...
  if (!empty($_FILES['txtImg']['name'])) {
    $insquery = "update game_detailss set title='{$txtTitle}',banner='{$txtImg}',url='{$txtUrl}',type='{$txtType}' where id = $id";
  }
  else
  {
    $insquery = "update game_detailss set title='{$txtTitle}',url='{$txtUrl}',type='{$txtType}' where id = $id"; 
  }
...
if(isset($_GET['did']))
{
  ...
  $delquery = "delete from game_detailss where id=$did";
            ...
            <div class="row">
              <div class="col-lg-5 col-md-5 col-sm-12">
                <div class="card-box">
                  ...
                  <form action="game-masterr.php?id=<?php echo $_GET['id'];?>" data-parsley-validate enctype="multipart/form-data" novalidate method="post">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group text-right m-b-0">
                          ...
                          <a href="game-masterr" class="btn btn-default waves-effect waves-light"> Cancel</a>
                        </div>
                      </div>
                    </div>
                  </form>
                  <?php } else { ?>
                  <form action="game-masterr.php" data-parsley-validate enctype="multipart/form-data" novalidate method="post">
                      ...
                      <tbody>
                        <?php while ($selres = mysqli_fetch_array($selres1)){ ?>
                          <tr class="font-13">
                              ...
                              <td>
                                <a href="game-masterr.php?id=<?php echo $selres['id'];?>" class="edit-row" style="color: #29b6f6;" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update Record"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                <a href="game-masterr.php?did=<?php echo $selres['id'];?>" class="remove-row" style="color: #f05050;" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Permanently" onclick="return checkDelete()"><i class="fa fa-trash-o"></i></a>
                              </td>
                          </tr>
                        <?php } ?>
                      </tbody>
